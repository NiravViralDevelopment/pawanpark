        ...
        <div class="card-body">
            <form action="{{ route('admin.teams.update', $team) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <p class="section-description">Optimize team member profile for search engines and social media sharing.</p>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="{{ old('meta_title', $team->meta_title) }}" 
                            placeholder="e.g., John Doe - Real Estate Agent | Gurukrupa Marketing"
                            maxlength="60"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            maxlength="160"
                        >{{ old('meta_description', $team->meta_description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="{{ old('meta_keywords', $team->meta_keywords) }}" 
                            placeholder="team, real estate agent, property consultant"
                        >
