        ...
        <div class="card-body">
            <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    >
                    <small class="form-text">Recommended size: 1920x600px. Max 5MB. Leave empty to keep current image</small>
                    @error('image')
                    ...
                    @if($banner->image)
                        <div style="margin-top: 15px;">
                            ...
                            <div class="image-preview-container">
                                <img id="currentImage" src="{{ asset($banner->image) }}" alt="Current Banner">
                            </div>
                        </div>
                    @endif
                ...
                <div class="form-section">
                    ...
                    <p class="section-description">Optimize your banner for search engines and social media sharing.</p>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            placeholder="e.g., Premium Real Estate Banner | Gurukrupa Marketing"
                            maxlength="60"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            maxlength="160"
                        >{{ old('meta_description', $banner->meta_description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="{{ old('meta_keywords', $banner->meta_keywords) }}" 
                            placeholder="banner, real estate, property, gurukrupa"
                        >
